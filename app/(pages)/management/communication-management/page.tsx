...
export default function Communications() {
  ...
  const handleBannerChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file && file.size <= 10 * 1024 * 1024 && (file.type === 'image/jpeg' || file.type === 'image/png')) {
      ...
      alert('Invalid file. Supported: JPEG, PNG up to 20MB.');
    }
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    openSuccessModal('Email campaign sent successfully.');
    router.push('/communications'); // Adjust route as needed
  };
          ...
          <div className="mb-6">
            ...
            <div className="border border-gray-300 rounded-2xl p-3">
              ...
              <div className="flex justify-between items-center mt-2 text-xs text-gray-500">
                <span>Character count: {message.length} of 500</span>
              </div>
            </div>
          </div>
